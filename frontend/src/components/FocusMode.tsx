...
const FocusMode: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-xl animate-in fade-in duration-300 px-4 py-6">
      <div className="relative w-full max-w-xl sm:max-w-2xl p-8 sm:p-12 text-center space-y-12">
        <button 
          onClick={onClose}
