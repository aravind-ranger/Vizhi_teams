...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] flex items-center justify-center p-6 font-sans text-slate-900">
      <div className="w-full max-w-md">
        {/* Logo Section */}
        <div className="flex flex-col items-center mb-12">
          <div className="w-56 h-56 bg-black rounded-[50px] flex items-center justify-center mb-6 shadow-2xl shadow-black/20 animate-scale-up p-4">
            <img src="/vizhi.svg" alt="Vizhi" className="w-full h-full object-contain" />
          </div>
          <h1 className="text-4xl font-black text-slate-900 tracking-tighter">VIZHI</h1>
          <p className="text-slate-400 text-[10px] font-black uppercase tracking-[0.5em] mt-3 ml-2">Advanced Engineering</p>
        </div>
        {/* Form Section */}
        <div className="bg-white p-10 rounded-[40px] shadow-[0_40px_80px_-20px_rgba(0,0,0,0.1)] border border-gray-100">
          <div className="mb-10 text-center">
            <h2 className="text-xl font-black text-slate-900 mb-2">Sign In</h2>
            <p className="text-slate-500 text-sm font-medium">Access your workspace</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  type="text" required
                  className="w-full h-14 pl-12 pr-6 bg-gray-50 border-none rounded-2xl focus:ring-4 focus:ring-primary/5 focus:bg-white transition-all outline-none font-bold text-sm text-slate-900"
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full h-14 pl-12 pr-12 bg-gray-50 border-none rounded-2xl focus:ring-4 focus:ring-primary/5 focus:bg-white transition-all outline-none font-bold text-sm text-slate-900"
                  placeholder="••••••••"
      ...
      {showForgotModal && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white w-full max-w-sm rounded-[40px] p-10 shadow-2xl animate-scale-up text-center">
            ...
            <h3 className="text-2xl font-black text-slate-900 mb-3">Forgot Password?</h3>
            <p className="text-slate-500 mb-8 font-medium">Please contact the administrator to reset your credentials.</p>
            <div className="flex flex-col space-y-3">
              ...
              <button
                ...
                className="w-full h-14 text-slate-400 font-black uppercase tracking-widest hover:text-slate-900 transition-colors"
              >
                Close
              </button>
            </div>
